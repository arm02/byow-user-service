...
// PublishOTP is a stub for the repository.UserRepository interface.
func (m *mockUserRepository) PublishOTP(payload interface{}) error {
	// For testing, just return nil or simulate publishing if needed.
	return nil
}
